...
| 사이트별 누적 저장 | chrome.storage.local에 사이트별 슬롯으로 저장, 재수집 시 해당 슬롯만 덮어씀. 중복 판별(platform+externalId 등)은 익스텐션이 하지 않고 웹앱 addApplicationsFromExtension이 전담 (상세: [INTEGRATION.md](./INTEGRATION.md)) | 🟡 중간 |
